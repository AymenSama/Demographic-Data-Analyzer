...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_series = df[df["salary"] == ">50K"]["native-country"].value_counts() / df["native-country"].value_counts()
    highest_earning_country = highest_earning_series.idxmax()
    highest_earning_country_percentage = round(highest_earning_series.max() * 100, 1)
